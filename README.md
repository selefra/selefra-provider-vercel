# Selefra Provider Vercel

Use this repo as a raw reference to **tables and schema** for Vercel resources. [Here's](https://github.com/selefra/selefra-provider-vercel/blob/main/docs/tables/vercel.md) a summary of full coverage.
